...
severity_color_map = {"Low": "#22C55E", "Medium": "#EAB308", "High": "#F97316",
                       "Critical": "#EF4444", "Unknown": "#94A3B8"}

fig = px.scatter_mapbox(
    df, lat="latitude", lon="longitude", color="severity", size="population",
    hover_name="district_name",
    hover_data={"risk_score": True, "population": True, "latitude": False, "longitude": False},
    color_discrete_map=severity_color_map, zoom=6.3, center={"lat": 10.5, "lon": 76.3},
    mapbox_style="carto-darkmatter" if st.session_state.get("dark_mode") else "carto-positron",
    height=600,
)
fig.update_layout(margin=dict(l=0, r=0, t=0, b=0), legend_title_text="Risk Level")
st.plotly_chart(fig, use_container_width=True)
st.caption("Marker size reflects population.")