...
print(
    f"weather_real.csv: matched {warnings_df.district_id.nunique()} districts, {len(warnings_df)} rows total"
)
...
print(
    f"disaster_history_real.csv: matched {disaster_df.district_id.nunique()} districts"
)
